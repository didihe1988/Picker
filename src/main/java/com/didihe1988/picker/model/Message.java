...
public class Message implements Serializable {
	 ...
	 */
	/*
	 * // ---DYNAMIC Starts 由关注产生的消息 用户的动态中显示--- // 小明 提出了问题 家用路由器会遭受攻击吗？ public
	 * static final int MESSAGE_FOLLOWED_ASKQUESTION = 1;
	 * 
	 * // 小明 回单了问题 我们用咖啡杯代表java，而当提到c++时，我们用什么？ Java 咖啡C++ 烫 public static final
	 * int MESSAGE_FOLLOWED_ANSWER_QUESTION = 2;
	 * 
	 * // 小明 赞了该问题 小米4手机、1+手机和nexus5手机应该买哪个？ public static final int
	 ...
	 * 
	 * // 小明 赞了该笔记 如何学习姿势 public static final int MESSAGE_FOLLOWED_FAVORITE_NOTE
	 * = 5;
	 * 
	 * // 小明 赞了您的评论 XXXX public static final int
	 ...
	 * 
	 * // 小明(被关注者)关注了XXX public static final int MESSAGE_FOLLOWEDUSER_FOLLOW =
	 * 17; // ---DYNAMIC Ends---
	 * 
	 * // ---UserRelated Starts 用户相关的消息 用户在消息通知中接受--- // 你的问题有了新的回答 public
	 * static final int MESSAGE_YOUR_QUESTION_UPDATE = 18; // 你的问题被点赞 public
	 * static final int MESSAGE_YOUR_QUESTION_FAVORITED = 19; // 你的回答被点赞 public
	 * static final int MESSAGE_YOUR_ANSWER_FAVORITED = 20; // 你的评论被点赞 public
	 * static final int MESSAGE_YOUR_COMMENT_FAVORITED = 21; // 你的笔记被点赞 public
	 * static final int MESSAGE_YOUR_NOTE_FAVORITED = 22; // 你的回答被评论 public
	 * static final int MESSAGE_YOUR_ANSWER_COMMENTED = 23; // 你的问题被评论 public
	 * static final int MESSAGE_YOUR_QUESTION_COMMENTED = 24; // 你被关注XXX了 public
	 * static final int MESSAGE_OTHERS_FOLLOW_YOU = 25;
	 * 
	 * // 缺少:XXX加入了你创建的圈子 UserRelated Ends // ---UserRelated Ends
	 * 
	 * //---Footprint Starts 用户动作产生的消息 在用户的profile里显示--- public static final int
