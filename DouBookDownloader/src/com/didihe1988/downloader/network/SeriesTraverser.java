...
public class SeriesTraverser {
	...
	public SeriesTraverser(int series, int startPage, int endPage) {
		this.series = series;
	...
	private HashSet<Integer> getIdsByPage(int page) throws IOException {
		...
		urlBuilder.append("http://book.douban.com/series/").append(this.series)
